...
public class quests : MonoBehaviour
{
    ...
    void Update()
    {
        //PlayerPrefs.SetString("Clicktotaldujour", "1201");
        //PlayerPrefs.SetString("Diamanddujour", "3");
        //user.modifargentquest(double.Parse(PlayerPrefs.GetString("Bestspeed", "0"), System.Globalization.CultureInfo.InvariantCulture) * 40f);
        //PlayerPrefs.SetString("Repeartotaldujour", "2");
        ...
        if (questqlicked == true)
        {
            ...
            else
            {
                ...
                if (q < 1f) clickdejanotifier = false;
            }
        ...
        if (questclickdiamand == true)
        {
            ...
            else
            {
                ...
                if (q < 1f) diamanddejanotifier = false;
            }
        ...
        if (questgain == true)
        {
            double q = double.Parse(user.getargentqueststring(), System.Globalization.CultureInfo.InvariantCulture) / (double.Parse(PlayerPrefs.GetString("Bestspeed", "1"), System.Globalization.CultureInfo.InvariantCulture) * 40f);

            if (q > 1f)
                q = 1f;
            gain.fillAmount = (float)q;
            if (double.Parse(user.getargentqueststring(), System.Globalization.CultureInfo.InvariantCulture) >= double.Parse(PlayerPrefs.GetString("Bestspeed", "1"), System.Globalization.CultureInfo.InvariantCulture) * 40f)
            {
                questgaintext.text = unite.UniteMethodP(double.Parse(PlayerPrefs.GetString("Bestspeed", "1"), System.Globalization.CultureInfo.InvariantCulture) * 40f) + "/" + unite.UniteMethodP(double.Parse(PlayerPrefs.GetString("Bestspeed", "1"), System.Globalization.CultureInfo.InvariantCulture) * 40f);

            }
            else
            {
                questgaintext.text = unite.UniteMethodP(double.Parse(user.getargentqueststring(), System.Globalization.CultureInfo.InvariantCulture)) + "/" + unite.UniteMethodP(double.Parse(PlayerPrefs.GetString("Bestspeed", "1"), System.Globalization.CultureInfo.InvariantCulture) * 40f);
            ...
            else
            {
                ...
                if (q < 1f) gaindejanotifier = false;
            }
        ...
        if (questrepear == true)
        {
            ...
            else
            {
                ...
                if (q < 1f) repeardejanotifier = false;
            }
    ...
    IEnumerator SpawnDiamondRoutine()
    {
        while (true)
        {
            ...
            float waitTime = Random.Range(120f, 240f);
