...
public class Scenetobox : MonoBehaviour
{
    ...
    public Image Vie;
    private GameObject parentselect;
    ...
    public void Onclick()
    {
        ...
        if (im != null && im.sprite != null)
        {
            ...
            parentselect = GameObject.Find("Canvas_mineur").transform.Find(PlayerPrefs.GetString("selecttostock")).gameObject;
    ...
    void SaveSpriteData(string spriteName)
    {
        ...
        data.spriteCounts.Add(new SpriteCountEntry { baseName = spriteName, upspeed = Getupdatespeed(), upheat = Getupdateheat(), vie = Vie.fillAmount, upspecial = PlayerPrefs.GetInt(parentselect.name + "UpSpecial")});
