...
public class musiquesons : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (PlayerPrefs.GetString("vibration") == "True")
        {
            if (PlayerPrefs.GetString("language") == "Francais")
                ...
                text.text = "Yes";
            text.GetComponent<RectTransform>().anchoredPosition = new Vector2(-0.03f, text.GetComponent<RectTransform>().anchoredPosition.y);
        ...
        else if (PlayerPrefs.GetString("vibration") == "False")
        {
            if (PlayerPrefs.GetString("language") == "Francais")
                ...
                text.text = "No";
            text.GetComponent<RectTransform>().anchoredPosition = new Vector2(0.04f, text.GetComponent<RectTransform>().anchoredPosition.y);
    ...
    public void Start()
    {
        ...
        sons.onValueChanged.AddListener(val => {
            PlayerPrefs.SetFloat("sons", val);
            PlayerPrefs.Save();
        });
