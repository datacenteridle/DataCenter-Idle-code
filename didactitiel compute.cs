...
public class DidactitielCompute : MonoBehaviour
{
    ...
    IEnumerator changeImage()
    {
        ...
        tempColor.a = 0f;
        blurr.color = tempColor;
        blurrprice.sortingLayerName = "box";
        blurrprice.sortingOrder = 12;
        if (PlayerPrefs.GetString("language") == "Francais")
        {
            audioSourcerobot.Play();
        ...
        boutonClique = false;
        yield return new WaitUntil(() => boutonClique);
        blurrspeed.sortingLayerName = "box";
        blurrspeed.sortingOrder = 12;
        ...
        tempColor.a = 0f;
        blurr.color = tempColor;
        blurrtemp.sortingLayerName = "box";
        blurrtemp.sortingOrder = 12;
